...
import { Filter, Puzzle, ArrowRight } from "lucide-react"
...
const patterns = [
  ...
  },
  {
    ...
    description: "Pattern for representing qualification and certification of components.",
  ...
  },
  {
    ...
    description: "Pattern for representing measurements and their units.",
    category: "Properties",
    complexity: "Simple",
    slug: "measurement",
  },
  {
    id: 6,
    title: "Process Flow Pattern",
    description: "Pattern for modeling sequential processes and workflows.",
    category: "Processes",
    complexity: "Complex",
    slug: "process-flow",
  },
  {
    id: 7,
    title: "Requirements Pattern",
    description: "Pattern for modeling requirements and their relationships.",
  ...
  {
    id: 8,
    title: "Fault Diagnosis Pattern",
    description: "Pattern for modeling fault diagnosis and troubleshooting.",
  ...
  {
    id: 9,
    title: "Temporal Relations Pattern",
    description: "Pattern for representing temporal relationships between events.",
    category: "Temporal",
    complexity: "Medium",
